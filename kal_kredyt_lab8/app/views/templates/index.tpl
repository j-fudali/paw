...
<body>
	...
	{if isset($user)}
		<div id="Stats" class="container">
			<div class="row">
				<div class="col span_4"><i class="info"><a href="{$config->action_url}calculate">Kalkulator
							kredytowy</a></i>
				</div>
				<div class="col span_4"><i class="info"><a href="{$config->action_url}protectedPageShow">Blokowana
							strona</a></i></div>
				<div class="col span_4"><i class="info"><a href="{$config->action_url}showResults">Wyniki</a></i></div>
